...
/*Xiaoke.Zhi@MULTIMEDIA.AUDIODRIVER.CODEC, 2019/06/26, Add for Max98937*/
#define CONFIG_SND_SOC_MAX98937 1
/*Liu.Yang@MULTIMEDIA.AUDIODRIVER.PLATFORM, 2019/10/25, add for mute_detect */
#define OPLUS_FEATURE_MUTE_DETECT 1
/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.CODEC, 2018/04/20, Add for tfa98xx codec*/
#define CONFIG_SND_SOC_TFA98XX 1
/*Juqiang.Geng@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/05/16, Add for speaker mute*/
#define OPLUS_FEATURE_SPEAKER_MUTE 1
/*zhenyu.dong@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/07/25, Add for tfa vi feedback */
