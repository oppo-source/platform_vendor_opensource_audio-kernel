...
static int rx_macro_digital_mute(struct snd_soc_dai *dai, int mute)
{
	...
	//Nan.Zhong@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/11/23, Add for update rx-macro fs_clk
					...
					int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		//Nan.Zhong@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/11/23,Modify for update rx-macro fs_clk
