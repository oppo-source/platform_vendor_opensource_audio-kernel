				...
				enum snd_jack_types jack_type)
{
	...
	if (!insertion) {
		...
		mbhc->zl = mbhc->zr = 0;
		#ifndef OPLUS_ARCH_EXTENDS
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.HeadsetDet 2016/01/01,
...
static int wcd_mbhc_initialise(struct wcd_mbhc *mbhc)
{
	...
	if (mbhc->mbhc_cb->hph_pull_up_control_v2)
		...
		#ifndef OPLUS_ARCH_EXTENDS
		/* Jianfeng.Qiu@PSW.MM.AudioDriver.HeadsetDet.1473948, 2018/07/09,
					   ...
					   unsigned long mode, void *ptr)
{
	...
	#ifndef OPLUS_ARCH_EXTENDS
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.HeadsetDet 2019/08/26, Modify for log*/
		      ...
		      bool impedance_det_en)
{
	...
	#endif /* OPLUS_ARCH_EXTENDS */
	#ifdef OPLUS_ARCH_EXTENDS
	/* Wei.Hua@MULTIMEDIA.AUDIODRIVER.HeadsetDet, 2020/12/3, workaround to fix headset recording pop noise*/
